...
export const AuditView: React.FC = () => {
  ...
  const questions: AuditQuestion[] = [
    ...
    },
    {
      id: 'audit-analytics',
      category: 'Privacy',
      question: 'Can I integrate lightweight telemetry like Plausible, PostHog, or Google Analytics?',
      violatesGuideline: true,
      explanation:
        'VIOLATION: The Privacy Rules strictly forbid all analytics: "No analytics, telemetry, usage metrics, or tracking network requests. Zero tracking requests".',
    },
    {
      id: 'audit-cookies',
      category: 'Privacy',
